...
import com.youyd.question.dao.blog.BgQuestionDao;
 ...
 **/
@Service
public class BgQuestionService {

	@Autowired
	private BgQuestionDao questionDao;
	...
	public Question findQuestionByPrimaryKey(String questionId) {
		Question question = questionDao.findQuestionDetail(questionId);
		return question;
	}
