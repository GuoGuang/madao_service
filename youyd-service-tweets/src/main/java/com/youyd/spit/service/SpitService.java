...
import com.youyd.tweets.dao.SpitDao;
...
public class SpitService {
	 ...
	 * @param tweets
	 */
	public void insertSpit(Spit tweets){
	 ...
	 * @param
	 */
	public void updateByPrimaryKeyfindive(Spit tweets) {
	...
	public Result findSpitByParentid(String parentId, Integer page, Integer size){
		Spit result = tweetsDao.findSpitByParentid(parentId);
		return new Result(true,StatusCode.OK.getCode(),StatusCode.OK.getMsg(),result);
	}
