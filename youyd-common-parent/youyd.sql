...
CREATE TABLE `tb_article`  (
  ...
  `column_id` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '专栏ID',
  ...
  `create_time` timestamp NULL DEFAULT NULL COMMENT '发表日期',
  ...
  `channel_id` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '所属频道',
...
-- ----------------------------
INSERT INTO `tb_article` VALUES ('1', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `tb_column`  (
  ...
  `check_time` timestamp NULL DEFAULT NULL COMMENT '审核日期',
  `state` varchar(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '状态',
...
CREATE TABLE `tb_comment`  (
  ...
  `publish_date` datetime NULL DEFAULT NULL COMMENT '评论日期',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `tb_gathering`  (
  ...
  `enroll_time` timestamp NULL DEFAULT NULL COMMENT '报名截止',
...
CREATE TABLE `tb_problem`  (
  ...
  `reply_time` timestamp NULL DEFAULT NULL COMMENT '回复日期',
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `tb_spit`  (
  ...
  `publish_time` timestamp NULL DEFAULT NULL COMMENT '发布日期(创建时间)',
...
CREATE TABLE `us_menu`  (
  `menu_id` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '菜单表主键',
  `menu_name` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '菜单名称',
  `parent_Id` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '父菜单id',
  `menu_sort` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '菜单排序',
...
-- Records of us_menu
-- ----------------------------
INSERT INTO `us_menu` VALUES ('1', 'root', '0', '1', '根目录');
...
-- Records of us_role
-- ----------------------------
INSERT INTO `us_role` VALUES ('1', '管理员', '一般是后台管理员用户', 'CU-001', '2018-11-24 20:33:49', '2018-12-23 20:33:55');
INSERT INTO `us_role` VALUES ('2', '普通用户', '网站的普通用户', 'CU-002', '2018-11-24 20:33:49', '2018-11-24 20:33:49');
...
-- ----------------------------
INSERT INTO `us_role_menu` VALUES ('1', '1', '1');
...
CREATE TABLE `us_user`  (
  ...
  `registered_date` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '注册日期',
  `update_date` timestamp NULL DEFAULT NULL COMMENT '修改日期',
  `last_date` timestamp NULL DEFAULT NULL COMMENT '最后登陆日期',
  ...
  `is_lock` char(1) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '是否锁定(0:未锁定,1已锁定)',
...
-- Records of us_user
-- ----------------------------
INSERT INTO `us_user` VALUES ('1', 'testuser', '111111', '男', '2018-01-08 15:39:19', NULL, NULL, '2018-11-24 20:05:07', NULL, NULL, NULL, NULL, NULL, 1, 0, NULL, NULL, NULL, NULL);
