...
-- Records of ar_tags
-- ----------------------------
INSERT INTO `ar_tags` VALUES ('1', '2019', '2019', '2019年标签', 'icon-math', '2019-01-30 19:07:24', '1', '2019-03-09 02:10:15');
INSERT INTO `ar_tags` VALUES ('2', '多肉植物', 'succulent', '多肉植物标签', 'icon-physics', '2019-01-30 19:07:24', '1', '2019-03-09 02:10:11');
INSERT INTO `ar_tags` VALUES ('3', 'LeetCode', 'LeetCode', 'LeetCode标签', 'icon-physics', '2019-01-30 19:07:24', '1', '2019-03-09 02:09:58');
...
CREATE TABLE `emp`  (
  ...
  CONSTRAINT `emp_deptno` FOREIGN KEY (`deptno`) REFERENCES `dept` (`deptno`) ON DELETE RESTRICT ON UPDATE RESTRICT,
...
INSERT INTO `emp` VALUES (1004, '半混', '经理', 1009, '2001-04-02', 29750.00, NULL, 30);
INSERT INTO `emp` VALUES (1005, '谢逊', '销售员', 1006, '2001-09-28', 12500.00, 14000.00, 10);
...
INSERT INTO `emp` VALUES (1008, '半混', '分析师', 1004, '2007-04-19', 30000.00, NULL, 20);
...
INSERT INTO `emp` VALUES (1013, '庞统', '分析师', 1004, '2001-12-03', 30000.00, 5845.00, 20);
...
-- ----------------------------
INSERT INTO `qa_answers` VALUES (1, 1, '1', '2019-04-04 21:11:46', '2019-03-21 21:11:49', 1, '1');
INSERT INTO `qa_answers` VALUES (2, 1, '2', '2019-03-13 21:11:54', '2019-03-20 21:11:56', 2, '2');
INSERT INTO `qa_answers` VALUES (3, 1, '3', '2019-03-13 21:11:54', '2019-03-20 21:11:56', 3, '3');
...
CREATE TABLE `tb_class`  (
  ...
  `c_name` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
...
-- Records of tb_class
-- ----------------------------
INSERT INTO `tb_class` VALUES (1, 'wanghaoyou');
INSERT INTO `tb_class` VALUES (2, 'linguoguang');
...
CREATE TABLE `tb_student`  (
  ...
  `s_name` varchar(20) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `s_sex` varchar(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci NULL DEFAULT NULL,
  `s_age` int(11) NULL DEFAULT NULL,
  `s_c_id` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`s_id`) USING BTREE,
  INDEX `s_c_id`(`s_c_id`) USING BTREE,
  CONSTRAINT `tb_student_ibfk_1` FOREIGN KEY (`s_c_id`) REFERENCES `tb_class` (`c_id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of tb_student
-- ----------------------------
INSERT INTO `tb_student` VALUES (1, 'Tom', 'male', 18, 1);
INSERT INTO `tb_student` VALUES (2, 'Jack', 'male', 19, 1);
INSERT INTO `tb_student` VALUES (3, 'Rose', 'female', 18, 1);
INSERT INTO `tb_student` VALUES (4, 'as', 'qw', 39, 2);
INSERT INTO `tb_student` VALUES (5, 'as', 'qw', 35, 2);
...
CREATE TABLE `us_job`  (
  ...
  `update_at` bigint(20) NULL DEFAULT NULL COMMENT '修改日期',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户板块/任务调度' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of us_job
-- ----------------------------
INSERT INTO `us_job` VALUES ('1', NULL, 'com.youyd.base.job.TestJob', '* * * * * ? *', 'TestJob', 'TEST_GROUP', 'TEST_TRIGGER', 'TEST_GROUP', 1, 1, 'Test Job for SpringBoot', 1557030916263, 1557030916264);

-- ----------------------------
-- Table structure for us_login_log
-- ----------------------------
DROP TABLE IF EXISTS `us_login_log`;
CREATE TABLE `us_login_log`  (
  ...
  `update_at` bigint(20) NULL DEFAULT NULL COMMENT '修改日期',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户板块/用户登录日志' ROW_FORMAT = Compact;

-- ----------------------------
-- Records of us_login_log
-- ----------------------------
INSERT INTO `us_login_log` VALUES ('1124361845681676290', '1', '127.0.0.1', 'Chrome', 'Windows 10', 1556903721289, 1556903721289);
INSERT INTO `us_login_log` VALUES ('1124361936127647745', '1', '127.0.0.1', 'Chrome', 'Windows 10', 1556903745784, 1556903745784);
INSERT INTO `us_login_log` VALUES ('1124543839216467969', '1', '127.0.0.1', 'Chrome', 'Windows 10', 1556947114934, 1556947114936);
INSERT INTO `us_login_log` VALUES ('1124545211714371585', '1', '127.0.0.1', 'Chrome', 'Windows 10', 1556947446153, 1556947446153);
INSERT INTO `us_login_log` VALUES ('1124570801762893826', '1', '127.0.0.1', 'Chrome', 'Windows 10', 1556953547263, 1556953547263);
INSERT INTO `us_login_log` VALUES ('1124593773974298625', '1', '127.0.0.1', 'Chrome', 'Windows 10', 1556959020567, 1556959020568);
INSERT INTO `us_login_log` VALUES ('1124595063701807105', '1', '127.0.0.1', 'Chrome', 'Windows 10', 1556959331817, 1556959331817);
INSERT INTO `us_login_log` VALUES ('1124595763810836482', '1', '127.0.0.1', 'Chrome', 'Windows 10', 1556959498706, 1556959498706);
INSERT INTO `us_login_log` VALUES ('1124597652224909313', '1', '127.0.0.1', 'Chrome', 'Windows 10', 1556959948942, 1556959948942);
INSERT INTO `us_login_log` VALUES ('1124662492410875905', '1', '127.0.0.1', 'Chrome', 'Windows 10', 1556975403775, 1556975403775);
INSERT INTO `us_login_log` VALUES ('1124668670389981186', '1', '127.0.0.1', 'Chrome', 'Windows 10', 1556976881003, 1556976881003);
INSERT INTO `us_login_log` VALUES ('1124679862332342273', '1', '127.0.0.1', 'Chrome', 'Windows 10', 1556979546153, 1556979546153);
INSERT INTO `us_login_log` VALUES ('1124890792349659137', '1', '127.0.0.1', 'Chrome', 'Windows 10', 1557029835042, 1557029835042);
INSERT INTO `us_login_log` VALUES ('1124891216486068226', '1', '127.0.0.1', 'Chrome', 'Windows 10', 1557029940118, 1557029940118);
INSERT INTO `us_login_log` VALUES ('1124958446154330113', '1', '127.0.0.1', 'Chrome', 'Windows 10', 1557045968545, 1557045968545);
INSERT INTO `us_login_log` VALUES ('1124959596463173634', '1', '127.0.0.1', 'Chrome', 'Windows 10', 1557046243178, 1557046243178);
INSERT INTO `us_login_log` VALUES ('1124960148093841410', '1', '127.0.0.1', 'Chrome', 'Windows 10', 1557046374701, 1557046374701);
INSERT INTO `us_login_log` VALUES ('1124960340457205762', '1', '127.0.0.1', 'Chrome', 'Windows 10', 1557046420564, 1557046420564);
INSERT INTO `us_login_log` VALUES ('1124971570269954050', '1', '127.0.0.1', 'Chrome', 'Windows 10', 1557049094206, 1557049094206);
INSERT INTO `us_login_log` VALUES ('1125032574286712834', '1', '127.0.0.1', 'Chrome', 'Windows 10', 1557063640245, 1557063640246);
INSERT INTO `us_login_log` VALUES ('1125038956608114690', '1', '127.0.0.1', 'Chrome', 'Windows 10', 1557065164106, 1557065164106);
INSERT INTO `us_login_log` VALUES ('1125039066599542785', '1', '127.0.0.1', 'Chrome', 'Windows 10', 1557065190339, 1557065190339);
...
-- ----------------------------
-- Table structure for us_opt_log
-- ----------------------------
DROP TABLE IF EXISTS `us_opt_log`;
CREATE TABLE `us_opt_log`  (
  `id` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '日志表',
...
-- Records of us_role
-- ----------------------------
INSERT INTO `us_role` VALUES ('1119477949450088449', '0', '7', '7', '7', '2019-04-20 13:48:37', '2019-04-20 13:48:37');
INSERT INTO `us_role` VALUES ('1119477963140296706', '0', '8', '8', '8', '2019-04-20 13:48:40', '2019-04-20 13:48:40');
INSERT INTO `us_role` VALUES ('1119477979514859522', '0', '9', '9', '9', '2019-04-20 13:48:44', '2019-04-20 13:48:44');
INSERT INTO `us_role` VALUES ('1119478007188877314', '0', '10', '10', '10', '2019-04-20 13:48:50', '2019-04-20 13:48:50');
INSERT INTO `us_role` VALUES ('1119478028072316929', '0', '11', '11', '11', '2019-04-20 13:48:55', '2019-04-20 13:48:55');
INSERT INTO `us_role` VALUES ('1119478294389649409', '0', '11', '11', '11', '2019-04-20 13:49:59', '2019-04-20 13:49:59');
INSERT INTO `us_role` VALUES ('1119478415353376770', '0', '11', '11', '11', '2019-04-20 13:50:28', '2019-04-20 13:50:28');
INSERT INTO `us_role` VALUES ('1119478601412702209', '0', '11', '11', '11', '2019-04-20 13:51:12', '2019-04-20 13:51:12');
INSERT INTO `us_role` VALUES ('1119478701941780482', '0', '11', '11', '11', '2019-04-20 13:51:36', '2019-04-20 13:51:36');
INSERT INTO `us_role` VALUES ('1119478833819086850', '0', '11', '11', '11', '2019-04-20 13:52:08', '2019-04-20 13:52:08');
...
INSERT INTO `us_user` VALUES ('1117358634357686273', '17667198751', '17667198751', '17667198751', '$2a$10$wez5ckssygtEFbXXSmzA/eWfiBUGACnR5KUh.N1/xkjrlo/SBklRG', '女', NULL, NULL, '17667198751@qq.com', '2019-04-14 17:27:10', NULL, NULL, NULL, NULL, NULL, NULL, NULL, '17667198751', '17667198751', NULL, NULL);
INSERT INTO `us_user` VALUES ('3', '157003', NULL, 'ZH001', '123456', '男', '2018-11-28 12:59:43', '头像是qq', '121@qq.com', '2018-11-28 12:59:43', NULL, NULL, 150, NULL, NULL, NULL, NULL, '15866969696', '山东省潍坊市昌邑市', '', 0);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1.000000000000000000000000000000, '张三', 18.000000000000000000000000000000);
INSERT INTO `user` VALUES (2.000000000000000000000000000000, '李四', 20.000000000000000000000000000000);
INSERT INTO `user` VALUES (3.000000000000000000000000000000, '王五', 30.000000000000000000000000000000);
INSERT INTO `user` VALUES (4.000000000000000000000000000000, '张三', 18.000000000000000000000000000000);
INSERT INTO `user` VALUES (5.000000000000000000000000000000, '王五', 19.000000000000000000000000000000);
INSERT INTO `user` VALUES (6.000000000000000000000000000000, '张三', 20.000000000000000000000000000000);
