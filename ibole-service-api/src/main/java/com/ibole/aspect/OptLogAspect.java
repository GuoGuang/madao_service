...
public class OptLogAspect {
	 ...
	 * 排除login方法
	 */
	//@Pointcut("execution (* com.ibole.*.controller..*.*(..)) && !execution(* com.ibole.*.controller.UserController.login(..))  && !execution(* com.ibole.*.controller.UserController.logout(..))")
	@Pointcut(value="@annotation(com.ibole.annotation.OptLog)")
	...
	public void doBefore(JoinPoint joinPoint) {
		...
		try {
			...
			//*========数据库日志=========*//
			com.ibole.pojo.base.OptLog log = new com.ibole.pojo.base.OptLog();
