    ...
    stages {
        ...
        stage("Maven构建") {
            ...
            steps {
                ...
                sh "/bin/cp /var/jenkins_home/service-config/publickey.txt codeif-authorization-server/src/main/resources/"
                sh "/bin/cp /var/jenkins_home/service-config/publickey.txt codeif-web-gateway/src/main/resources/"
